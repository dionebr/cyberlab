...
-- WARNING: This data is INTENTIONALLY INSECURE
-- For vulnerability demonstration
-- DO NOT use real data!

USE cyberlab_vulnerable;

-- INSERT VULNERABLE USERS
-- Weak passwords, exposed sensitive information
...
-- Regular user with leaked information
...
-- Inactive user with sensitive data
...
-- Test user with SQL injection in notes
...
-- INSERT SYSTEM CONFIGURATIONS (sensitive)
...
-- INSERT VULNERABLE FILE UPLOADS
...
-- INSERT PRODUCTS WITH SENSITIVE INFORMATION
...
-- INSERT ORDERS WITH PAYMENT INFORMATION
...
-- INSERT CLASSIFIED DATA FOR ADVANCED TESTS
...
-- INSERT VULNERABLE SECURITY LOGS
...
-- Insert statistics for dashboard
